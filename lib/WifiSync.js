...
const WifiSync = {
    ...
    start({
        ...
        const server = require('http').createServer((req, res) => {
            ...
            const zipPath = "/Users/Roy/Desktop/test.zip";
            ...
            if (req.headers['range']) {
                ...
                if (range) {
                    console.log('content range->', "bytes " + range.start + "-" + range.end + "/" + stat.size);
                    console.log('content length->', (range.end - range.start + 1));
                    console.log('--------------------------------------------------------')
